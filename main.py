...
def crop_sprites(image_path, num_moves, sprite_width, sprite_height, output_path):
...
num_moves = 16  # Number of moves in the spritesheet
sprite_width = 32  # Width of each sprite
sprite_height = 32  # Height of each sprite
output_path = "output_sprites"

crop_sprites(image_path, num_moves, sprite_width, sprite_height, output_path)
